...
#==============================================================================
filename = '../data/HE0435_F555W_sci.fits'
...
# pyfits.PrimaryHDU(img_sub).writeto('../data/HE0435_F555W_sci_sublight.fits',overwrite=True)
img_sub = pyfits.getdata('../data/HE0435_F555W_sci_sublight.fits')
...
wht =pyfits.getdata('../data/HE0435_F555W_wht.fits')
