...
#      lensed_QSO1 pos: 105, 115, np.array([4,14]), intensity 304.1
#      lensed_QSO2 pos: 117, 101, np.array([16,0]) intensity 304.1
#      lensed_QSO3 pos: 98, 88, np.array([-3,-13]), intensity 304.1
#      lensed_QSO4 pos: 86, 109, np.array([-15,9]) intensity 304.1
# =============================================================================
fixed_source = []
kwargs_source_init = []
kwargs_source_sigma = []
...
kwargs_upper_ps = []
fixed_ps.append({})
kwargs_ps_init.append({'ra_image': [-0.32], 'dec_image': [1.12], 'point_amp': [304.1]})
kwargs_ps_sigma.append({'ra_image': [0.02], 'dec_image': [0.02]})
kwargs_lower_ps.append({'ra_image': [-0.32-0.2], 'dec_image': [1.12-0.2]})
kwargs_upper_ps.append({'ra_image': [-0.32+0.2], 'dec_image': [1.12+0.2]})

fixed_ps.append({})
kwargs_ps_init.append({'ra_image': [-1.28], 'dec_image': [-0.0], 'point_amp': [304.1]})
kwargs_ps_sigma.append({'ra_image': [0.02], 'dec_image': [0.02]})
kwargs_lower_ps.append({'ra_image': [-1.28-0.2], 'dec_image': [0.-0.2]})
kwargs_upper_ps.append({'ra_image': [-1.28+0.2], 'dec_image': [0.+0.2]})

fixed_ps.append({})
kwargs_ps_init.append({'ra_image': [0.24], 'dec_image': [-1.04], 'point_amp': [304.1]})
kwargs_ps_sigma.append({'ra_image': [0.02], 'dec_image': [0.02]})
kwargs_lower_ps.append({'ra_image': [0.24-0.2], 'dec_image': [-1.04-0.2]})
kwargs_upper_ps.append({'ra_image': [0.24+0.2], 'dec_image': [-1.04+0.2]})

fixed_ps.append({})
kwargs_ps_init.append({'ra_image': [1.2], 'dec_image': [0.72], 'point_amp': [304.1]})
kwargs_ps_sigma.append({'ra_image': [0.02], 'dec_image': [0.02]})
kwargs_lower_ps.append({'ra_image': [1.2-0.2], 'dec_image': [0.72-0.2]})
kwargs_upper_ps.append({'ra_image': [1.2+0.2], 'dec_image': [0.72+0.2]})
...
# =============================================================================
#The fitting result:
#[{'dec_image': array([ 1.16127952]),
#  'point_amp': array([ 271.38895639]),
#  'ra_image': array([-0.28236455])},
# {'dec_image': array([ 0.00776723]),
#  'point_amp': array([ 312.028478]),
#  'ra_image': array([-1.27285264])},
# {'dec_image': array([-1.00253835]),
#  'point_amp': array([ 247.01906864]),
#  'ra_image': array([ 0.26093594])},
# {'dec_image': array([ 0.6075612]),
#  'point_amp': array([ 353.96787894]),
#  'ra_image': array([ 1.1935496])}]
...
kwargs_lens_init = [{'theta_E': 1.2, 'gamma': 2., 'e1': 0, 'e2': 0, 'center_x': 0., 'center_y': 0}, {'e1': 0.00, 'e2': -0.0}]
