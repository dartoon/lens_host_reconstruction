...
old_folder = '../2nd_fit_PSFi'+path.split('fit_PSFi')[1]
...
stdd_boost_filename = '../fit_PSFi_QSOmask/'+'{0}_stdd_boost.fits'.format(ID)
...
for psf_id in [0,1,2,3]:
    for subg in [3,2]:
        ...
        kwargs_constraints = {'joint_lens_with_light': [[1, 1, ['center_x', 'center_y']]],
...
#                              'ra_image': np.array([ 2.0255986 ,  2.05805554,  1.45340261, -1.24606631])}]
        ...
        #Correct for the previous mistake of the object light:
        kwargs_lens_light_init[1]['center_x'], kwargs_lens_light_init[1]['center_y'] =0.06607529289162566, 0.5663842386650706
        kwargs_lens_init[1]['center_x'], kwargs_lens_init[1]['center_y'] =0.06607529289162566, 0.5663842386650706
