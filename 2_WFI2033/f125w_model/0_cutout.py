...
#==============================================================================
filename = '../data/WFI2033_added/f125w_drz_sci.fits'
...
# pyfits.PrimaryHDU(img_sub).writeto('../data/WFI2033_added/f125w_drz_sci_sublight.fits',overwrite=True)
img_sub = pyfits.getdata('../data/WFI2033_added/f125w_drz_sci_sublight.fits')
...
taka_lens_rms =pyfits.getdata('../data/WFI2033_added/f125w_drz_rms.fits')
...
##%%
psfs_pos = np.array([[861, 513],[947, 292]])
