...
#pyfits.PrimaryHDU(img_sub).writeto('../otherband_data/f140w_drz_sci_sublight.fits',overwrite=True)
img_sub = pyfits.getdata('../otherband_data/f140w_drz_sci_sublight.fits')
...
taka_lens_rms =pyfits.getdata('../otherband_data/f140w_drz_rms.fits')
...
#
##%%
#psfs_pos = np.array([[1505, 169], [347, 303],[1908, 395], [1194, 682],[1957, 1285],[160, 1315],[2126, 1829],[1836, 2025] ])
