...
#pyfits.PrimaryHDU(img_sub).writeto('../otherband_data/f555w_drz_sci_sublight.fits',overwrite=True)
img_sub = pyfits.getdata('../otherband_data/f555w_drz_sci_sublight.fits')
...
taka_lens_rms =pyfits.getdata('../otherband_data/f555w_drc_rms.fits')
...
##%%
#psfs_pos = np.array([[1094, 1160],[6705, 1685],[1589, 5217],[6826, 6928],[5657, 3983]])
