...
#                          'ra_image': np.array([-0.51918733, -0.56006618])}]
        ...
        if 'e1' in kwargs_result['kwargs_lens'][-2].keys():
            g1 = kwargs_result['kwargs_lens'][-2]['e1']
            g2 = kwargs_result['kwargs_lens'][-2]['e2']
            kwargs_result['kwargs_lens'][-2]= {'gamma1': g1, 'gamma2': g2}  #This is a special one
