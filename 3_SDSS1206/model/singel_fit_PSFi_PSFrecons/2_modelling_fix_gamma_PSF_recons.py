...
for fix_gamma in [[1.9, 2.0, 2.1][id_ind]]:
    for psf_id in [0,1,2]:
        for subg in [3,2]:
            ...
            psf_std_file =  glob.glob('../PSF{0}_std.fits'.format(psf_id))
            if psf_std_file !=[]:
                print "This PSF will input the PSF_std (Simon's)"
                psf_std = pyfits.getdata(psf_std_file[0])
    ...
    #                             }
            ...
            kwargs_lens_init = [{'center_x': 0.025294402098616758,
                         ...
                         {'dec_0': 0,
                          'gamma1': 0.009890975967993336,
                          'gamma2': 0.11343461385823016,
                          'ra_0': 0},
                          {'center_x': -1.6,
                          'center_y': 2.5,
            ...
            labels_new = labels_new = ["AGN flux in image plane", "Host flux image plance", "AGN flux in souce plane", "Host flux souce plane",  "Host Sersic", "Sersic Reff"]
