...
#==============================================================================
fitsFile = pyfits.open('../data/HS2209+1914_F814W_vis05_sci.fits')

from my_astro_func import read_pixel_scale
pixscl = read_pixel_scale('../data/HS2209+1914_F814W_vis05_sci.fits')


#img = fitsFile[0].data # check the back grounp
#img[img==0.] = np.nan
#img_sub, bkg_light = sub_bkg(img)
#pyfits.PrimaryHDU(img_sub).writeto('../data/HS2209_vis05_sublight.fits',overwrite=True)
img_sub = pyfits.getdata('../data/HS2209_vis05_sublight.fits')
#%%
center_QSO = np.array([4888-1,5020-1]) #c_psf_list[QSO_loc]
...
wht = pyfits.getdata('../data/HS2209+1914_F814W_vis05_wht.fits')
exp = read_fits_exp('../data/HS2209+1914_F814W_vis05_sci.fits') #4542.0
...
#%%
psfs_pos = np.array([[4771, 5309],[4374, 5958],[4136, 6144]])  #The [4081, 5232] is too bright and saturated.
