...
lens_params = [kwargs_lens_init, kwargs_lens_sigma, [{'gamma': 2.0}, {'ra_0': 0, 'dec_0': 0}], kwargs_lower_lens, kwargs_upper_lens]
...
filename='fit_result_PSFave_mask_gammafix'
...
plt.savefig('fig_PSFave_mask_gammafix_img0.pdf')
plt.show()
...
f.tight_layout()
f.subplots_adjust(left=None, bottom=None, right=None, top=None, wspace=0., hspace=0.05)
plt.savefig('fig_PSFave_mask_gammafix_img1.pdf')
plt.show()
...
fig.savefig('fig_PSFave_mask_gammafix_corner.pdf')
plt.show()
