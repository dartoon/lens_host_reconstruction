...
#plt.savefig('fig_PSFavestd_PSFrecons_gammafix_comp.pdf')
plt.show()

##If to save the fitting reuslt as the pickle:
#filename='fit_result_PSFavestd_PSFrecons_gammafix_subg{0}'.format(subg)
...
plt.savefig('fig_PSFavestd_PSFrecons_gammafix_subg{0}_img0.pdf'.format(subg))
plt.show()
...
f.tight_layout()
f.subplots_adjust(left=None, bottom=None, right=None, top=None, wspace=0., hspace=0.05)
plt.savefig('fig_PSFavestd_PSFrecons_gammafix_subg{0}_img1.pdf'.format(subg))
plt.show()
...
fig.savefig('fig_PSFavestd_PSFrecons_gammafix_subg{0}_corner.pdf'.format(subg))
plt.show()

picklename='result_PSFavestd_PSFrecons_gammafix_subg{0}'.format(subg)
