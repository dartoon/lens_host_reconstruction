...
filename='fit_result_PSFavenostd_gammafix'
...
plt.savefig('fig_PSFavenostd_gammafix_img0.pdf')
plt.show()
...
f.tight_layout()
f.subplots_adjust(left=None, bottom=None, right=None, top=None, wspace=0., hspace=0.05)
plt.savefig('fig_PSFavenostd_gammafix_img1.pdf')
plt.show()
...
fig.savefig('fig_PSFavenostd_gammafix_corner.pdf')
plt.show()
