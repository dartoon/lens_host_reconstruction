...
filename='fit_result_PSF{0}_QSOmask_gammafix_subg2_corrstd'.format(psfno)
...
plt.savefig('fig_PSF{0}_QSOmask_gammafix_subg2_corrstd_img0.pdf'.format(psfno))
plt.show()
...
f.tight_layout()
f.subplots_adjust(left=None, bottom=None, right=None, top=None, wspace=0., hspace=0.05)
plt.savefig('fig_PSF{0}_QSOmask_gammafix_subg2_corrstd_img1.pdf'.format(psfno))
plt.show()
...
fig.savefig('fig_PSF{0}_QSOmask_gammafix_subg2_corrstd_corner.pdf'.format(psfno))
plt.show()
