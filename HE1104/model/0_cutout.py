...
#==============================================================================
fitsFile = pyfits.open('../data/HE1104_sci.fits')
img = fitsFile[0].data # check the back grounp
img[img==0.] = np.nan
#img_sub, bkg_light = sub_bkg(img)
#pyfits.PrimaryHDU(img_sub).writeto('../data/HE1104_sublight.fits',overwrite=True)
img_sub = pyfits.getdata('../data/HE1104_sublight.fits')
center_QSO = np.array([1246,1251]) #c_psf_list[QSO_loc]
...
#==============================================================================
wht = pyfits.getdata('../data/HE1104_wht.fits')
exp = 14698.2597
...
#==============================================================================
psfs_pos = np.array([[862,1191],[1302,1068],[337,726],[1301,514],[446,1047]])
...
#    PSFs
#==============================================================================
#pyfits.PrimaryHDU(lens_image).writeto('HE1104_cutout.fits',overwrite=True) 
#pyfits.PrimaryHDU(lens_rms).writeto('HE1104_stdd.fits',overwrite=True) 
