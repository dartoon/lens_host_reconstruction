...
'''
image_matt_sub = pyfits.getdata('../data/HE1104_bgsub.fits')
...
#    PSFs
#==============================================================================
pyfits.PrimaryHDU(lens_image_sub).writeto('HE1104_cutout.fits',overwrite=True) 
pyfits.PrimaryHDU(lens_rms).writeto('HE1104_noisemap.fits',overwrite=True) 
