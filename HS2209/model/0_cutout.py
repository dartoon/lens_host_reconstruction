...
#==============================================================================
fitsFile = pyfits.open('../data/HS2209+1914_F814W_sci.fits')

from my_astro_func import read_pixel_scale
pixscl = read_pixel_scale('../data/HS2209+1914_F814W_sci.fits')


img = fitsFile[0].data # check the back grounp
img[img==0.] = np.nan
#img_sub, bkg_light = sub_bkg(img)
#pyfits.PrimaryHDU(img_sub).writeto('../data/HS2209_sublight.fits',overwrite=True)
img_sub = pyfits.getdata('../data/HS2209_sublight.fits')

#%%
center_QSO = np.array([2780-1,3155-1]) #c_psf_list[QSO_loc]
...
wht = pyfits.getdata('../data/HS2209+1914_F814W_wht.fits')
exp = read_fits_exp('../data/HS2209+1914_F814W_sci.fits') #9712.0
...
#%%
psfs_pos = np.array([[2602, 2554],[2149, 1904],[6195, 2618], [3257, 3150], [2663, 3444], [2029, 4279], [2938,3223]])
