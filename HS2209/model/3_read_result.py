...
#filename = 'fit_PSFi_QSOmask/result_PSF1_Shost_Slens_subg3'
filename = 'fit_PSFi_PSFrecons/result_PSF1_Shost_Slens_subg3'
...
lens_image = pyfits.getdata('HS2209_cutout.fits')
lens_rms = pyfits.getdata('HS2209_stdd.fits')
...
from read_chisq import reg_light_model_list, reg_lens_model_list
lens_model_list = reg_lens_model_list(lens_result)
lens_model_class = LensModel(lens_model_list=lens_model_list)
lens_light_model_list = reg_light_model_list(lens_light_result)
