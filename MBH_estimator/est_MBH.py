...
#Lbol for Mgii should be -np.log10(5.15)  # In Dominique, it is the Lbol measured, and one should change it to L_3000. For HS2209, Dominique direct provide me the L_3000.
...
BL_info =  {'HE0435': {'Mgii': {'L': [45.7 -np.log10(5.15), 46.0 -np.log10(5.15)], 'FWHM':  4930.0}},
                 ...
                 'SDSS1206': {'Mgii': {'L': [(44.23-2.22)/0.909 -np.log10(4.)*2.], 'FWHM':   5632.4}},  #-np.log10(4.)/2. is for the magnification correction.
                 ...
                 'HS2209': {'Mgii': {'L': [np.log10(5.08*10**45)], 'FWHM':   3245}}} 
