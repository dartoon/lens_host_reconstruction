...
kwargs_lens_light_init = [{'e1': -0.011260147527026164, 'n_sersic': 4.2547680055199235,
                           'center_x': 0.097, 'center_y': 0.6159, 'R_sersic': 1.5538089469852707,
...
kwargs_lower_lens_light.append({'R_sersic': 0.001, 'center_x':  0.097-0.2, 'center_y': 0.6159-0.2})
...
kwargs_upper_lens_light.append({'R_sersic': 10, 'center_x': 0.097+0.2, 'center_y': 0.6159+0.2})
