...
kwargs_source_init = [{'R_sersic': 0.3, 'n_sersic': 3., 'e1': 0, 'e2': 0,
                       'center_x': -0.034062578898482215, 'center_y': 0.02660949329285192}]
...
kwargs_ps_init = [{'dec_image': np.array([ 0.39609909, -0.35840508]),
  'ra_image': np.array([-0.51409801,  0.43356512])}]
