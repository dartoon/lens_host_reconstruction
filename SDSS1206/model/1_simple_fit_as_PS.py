...
lens_image = pyfits.getdata('SDSS1246_cutout.fits')
lens_rms = pyfits.getdata('SDSS1246_stdd.fits')
...
x0, y0 =  -(float(x[0]) - center) * 0.08 , (float(y[0]) - center) * 0.08
x1, y1 =  -(float(x[2]) - center) * 0.08 , (float(y[2]) - center) * 0.08
...
kwargs_lens_init = [{'theta_E': 1.54, 'gamma': 2., 'e1': 0, 'e2': 0, 'center_x': 0., 'center_y': 0}, {'e1': 0.00, 'e2': -0.0}]
