...
kwargs_lens_init, kwargs_source_init, kwargs_lens_light_init, kwargs_ps_init =   lens_result, source_result, lens_light_result, ps_result
## initial guess of non-linear parameters, we chose different starting parameters than the truth #
#kwargs_lens_init = [{'center_x': 0.03017114666773656,
#                  'center_y': -0.09476757049014535,
#                  'e1': 0.12477769323340523,
#                  'e2': 0.09092699018142968,
#                  'gamma': fix_gamma,
#                  'theta_E': 1.3515626041432722},
#                 {'center_x': -0.14083367606213698,
#                  'center_y': 0.9113013630755783,
#                  'theta_E': 0.22241033595523393},
#                 {'e1': 0.008535897646332623,
#                  'e2': 0.11588581098524489}]
#kwargs_source_init = [{'R_sersic': 0.02167773873426621,
#                  'center_x': 0.027491104460238502,
#                  'center_y': -0.18837125506478392,
#                  'e1': -0.4019539251880953,
#                  'e2': -0.1725929662994096,
#                  'n_sersic': 4},
#                 {'R_sersic': 0.24821884877446837,
#                  'center_x': 0.0033325723224385236,
#                  'center_y': -0.19446943603727462,
#                  'e1': -0.013172318789880377,
#                  'e2': -0.13761233922586577,
#                  'n_sersic': 1}]
#kwargs_lens_light_init = [{'R_sersic': 0.661048588279974,
#                          'center_x': -0.0017827669154830059,
#                          'center_y': 0.015748752638512917,
#                          'e1': 0.056206131500393774,
#                          'e2': -0.02791131954130707,
#                          'n_sersic': 4},
#                         {'R_sersic': 0.913399205887693,
#                          'center_x': -0.07098150979695414,
#                          'center_y': 0.015448271505244146,
#                          'e1': -0.18972258138964238,
#                          'e2': 0.20158365624687463,
#                          'n_sersic': 1},
#                         {'R_sersic': 0.07629605804109643,
#                          'center_x': 0.050715818907204106,
#                          'center_y': -0.017843387288477983,
#                          'n_sersic': 1}]
#kwargs_ps_init =[{'dec_image': np.array([ 1.2165751 , -1.81718475]),
#                  'ra_image': np.array([-0.51794   , -0.54958559])}]
