...
subg_list = [2,3]
fname = 'fit_again_UPversion_DhostDlens_fixG1c_SISG2_subg'
...
for subg in subg_list:
    ...
    fitting_kwargs_list_0 = [['PSO', {'sigma_scale': 1., 'n_particles': 350, 'n_iterations': 350}]
            ]
    ...
    #                         ['psf_iteration', {'num_iter': 100, 'psf_iter_factor': 0.2, 'block_center_neighbour': 0.5}],
    #                         ['PSO', {'sigma_scale': 1., 'n_particles': 100, 'n_iterations': 100}],
                             ['MCMC', {'n_burn': 40, 'n_run': 40, 'walkerRatio': 10, 'sigma_scale': .1}]
        ]
