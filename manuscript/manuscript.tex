...
Note that the residual maps are appears to be less ideal than the ones as presented by Ken[]. The major reason is the definition of the host galaxy. We compare the result with the inferred host galaxy by Ken[] and Ding+2017.
