...
def text_description(ax, d, text, color='w', backgroundcolor='k',
    ...
    if flipped:
        ...
        ax.text(d * c_horizontal, d - d * c_vertical, text, color=color, fontsize=20,
                backgroundcolor=backgroundcolor)
def text_description_2(ax, d, text, color='w', backgroundcolor='k',
                     flipped=False, font_size=20):
    c_vertical =  4/20
    c_horizontal = 1./20
    if flipped:
