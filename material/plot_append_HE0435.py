...
file_555w = '/f555w_model/fit_PSFi_PSFrecons/result_PSF0_*_gammafix1.9*.pkl'
file_814w = '/f814w_model/fit_PSFi_PSFrecons/result_PSF1_*_gammafix1.9*.pkl'
#
filename = glob.glob('../'+IDs[0]+file_814w )
