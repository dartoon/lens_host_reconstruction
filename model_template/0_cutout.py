...
#==============================================================================
fitsFile = pyfits.open('../data/LensID_sci.fits')
...
'''
image_matt_sub = pyfits.getdata('../data/LensID_bgsub.fits')
...
#==============================================================================
wht = pyfits.getdata('../data/LensID_wht.fits')
...
#==============================================================================
psfs_pos = np.array([[xxx,xxx],[xxx,xxx],[xxx,xxx]) #!!!!Need to be change
