...
fixed_ps.append({})
fixed_ps.append({})
kwargs_ps_init.append({'ra_image': [arr_x_s[0]], 'dec_image': [arr_y_s[0]], 'point_amp': [1500]})
kwargs_ps_sigma.append({'ra_image': [0.02], 'dec_image': [0.02]})
kwargs_lower_ps.append({'ra_image': [arr_x_s[0]-0.2], 'dec_image': [arr_y_s[0]-0.2]})
kwargs_upper_ps.append({'ra_image': [arr_x_s[0]+0.2], 'dec_image': [arr_y_s[0]+0.2]})

fixed_ps.append({})
kwargs_ps_init.append({'ra_image': [arr_x_s[1]], 'dec_image': [arr_y_s[1]], 'point_amp': [1500]})
kwargs_ps_sigma.append({'ra_image': [0.02], 'dec_image': [0.02]})
kwargs_lower_ps.append({'ra_image': [arr_x_s[1]-0.2], 'dec_image': [arr_y_s[1]-0.2]})
kwargs_upper_ps.append({'ra_image': [arr_x_s[1]+0.2], 'dec_image': [arr_y_s[1]+0.2]})
