...
for i in range(len(IDs)):
    ID = IDs[i][2:]
    root = '../'+ IDs[i]+ '/model/'
    pkl_folderfiles = glob.glob(root+"2nd_fit_PSFi_PSFrecons/result_PSF*.pkl")
    ...
    picklename = ID+'_2nd_run_summary.pkl'
...
#fit_value_l_list, fit_value_m_list, fit_value_h_list = chisq
#
